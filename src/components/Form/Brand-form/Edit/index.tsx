...
const BrandUpdateForm = ({BrandId,brand}:Props) => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<TSchema>({ resolver: zodResolver(Schema),defaultValues:{name:brand.brandname,description:brand.description,imageFile:brand.image}
