  ...
  return (
    <div className="rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
      <div className="text-lg font-extrabold flex justify-between dark:text-white text-black mb-4">Brand
       <Link href={"/forms/brand-form/add"} > <button className="bg-black dark:bg-white rounded-lg py-1 dark:text-black text-white text-base font-medium px-5">Add Brand</button></Link>
      </div>
          ...
          <tbody>
            ...
            {brandList.map((brandItem:any, index:any) => (
              <tr key={index}>
                ...
                <td
                  className={`border-[#eee]  py-4 dark:border-dark-3 xl:pl-7.5 ${index === brandList.length - 1 ? "border-b-0" : "border-b"}`}
                >
                  
                  <Image
                   src= {storageUrl +  brandItem.logo}
                   alt="brand logo"
                   width={50}
                   height={50}
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5 ${index === brandList.length - 1 ? "border-b-0" : "border-b"}`}
                >
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7.5 ${index === brandList.length - 1 ? "border-b-0" : "border-b"}`}
                >
                  <div className="flex items-center justify-end space-x-3.5">
                    <button className="hover:text-primary">
                      <Link href={`/forms/brand-form/${brandItem._id}`}>
                    <svg
