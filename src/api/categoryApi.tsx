...
export const categoryApi = {
    createCategory : async function(body:any){
        return   await axiosClient.post('categories/' ,body,{headers: {
    ...
    getAllCategory : async function(){
        return await axiosClient.get('categories/allcategories' )
    },
    ...
    getCategoryList :  async function (){
        return await axiosClient.get('categories/categorylist' )
}
}